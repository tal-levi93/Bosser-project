...
import ArtistImg2ProgressBar from "../../img2/progressBarArtistImg2";
    ...
    return (
        <div id={"gform"}>
            ...
            <div className="goutput">
                ...
                { file && <ArtistImg2ProgressBar file={file} setFile={setFile}  setUrl = {handleUrl} ArtistId={props.user_id} /> }
            </div>
        </div>
    );
}
